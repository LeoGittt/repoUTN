...
cosasQueMeGustan = ["pizza", "futbol", "fifa", "música", "helado"]
penultimo = cosasQueMeGustan[-2]
...
listaPalabras = []
listaPalabras.append("programar")
listaPalabras.append("mate")
listaPalabras.append("futbol")
print(listaPalabras)
...
# lo que hace es crear una lista de numeros con los vcalores puestos [8, 15, 3, 22, 7]. luego el programa busca el numero mas grande 
# de esa lista usando la funcion max(numeros), el numero mas grande e s 22. despues elimina ese numero usando la funcion remove. 
# borrando el 22 de la lista. al final se muestra la lista modificada con un print(numeros)
